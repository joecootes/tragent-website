      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 w-full">
        <div className="lg:grid lg:grid-cols-12 lg:gap-16 lg:items-center">
          ...
          <div className="lg:col-span-7">
            ...
            <h1 className="text-[48px] sm:text-6xl xl:text-[72px] font-black text-brand-text leading-[0.98] tracking-[-0.05em] mb-7 text-balance">
              Never miss another enquiry.
            </h1>

            <p className="text-lg sm:text-xl text-brand-text/60 leading-relaxed mb-9 max-w-xl">
          ...
          {/* Right: Product screenshot — desktop only */}
          <div className="hidden lg:flex lg:col-span-5 justify-end items-start pt-4">
            <div
            ...
            >
              <img
                ...
                alt="Tragent Today screen showing active jobs and new enquiries"
                draggable={false}
                style={{
                  position: 'absolute',
                  width: 255,
